class HedgeCalculator:
    ...
    def calculate_hedge_to_place(self, hedge_required, existing_hedge, VIF, tolerance):
        # If the hedge required is greater than the VIF and the VIF the existing hedge
        # is equal to or greater than 250000
        ...
        # Else if the hedge required is less than the VIF and the hedge required - the
        # existing hedge is equal to or greater than 250000
